...
public class GrepSoundLoader extends AsyncTaskLoader<Bundle> {
    ...
    public GrepSoundLoader(Context context, String input) {
        super(context);
    ...
    private void goGetSomeCookies(String songPage, String title) throws IOException {
        ...
        File mTrackDownloadFile = new File(getContext().getExternalCacheDir(), title+".mp3");
